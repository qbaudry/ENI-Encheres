				...
				<div class="row col-12 pt-3">
					<div class="col-6">
						<div class="custom-control custom-checkbox">
						  <input type="checkbox" class="custom-control-input" id="encheres_ouvertes">
						  <label class="custom-control-label" for="encheres_ouvertes">Enchères ouvertes</label>
						</div>
						<div class="custom-control custom-checkbox">
						  <input type="checkbox" class="custom-control-input" id="encheres_encours">
						  <label class="custom-control-label" for="encheres_encours">Mes enchères en cours</label>
						</div>
						<div class="custom-control custom-checkbox">
						  <input type="checkbox" class="custom-control-input" id="encheres_remportees">
						  <label class="custom-control-label" for="encheres_remportees">Mes enchères remportées</label>
						</div>
					</div>
					<div class="col-6">
						<div class="custom-control custom-checkbox">
						  <input type="checkbox" class="custom-control-input" id="ventes_encours">
						  <label class="custom-control-label" for="ventes_encours">Mes ventes en cours</label>
						</div>
						<div class="custom-control custom-checkbox">
						  <input type="checkbox" class="custom-control-input" id="ventes_non_debutees">
						  <label class="custom-control-label" for="ventes_non_debutees">Ventes non débutées</label>
						</div>
						<div class="custom-control custom-checkbox">
						  <input type="checkbox" class="custom-control-input" id="ventes_terminees">
						  <label class="custom-control-label" for="ventes_terminees">Ventes terminées</label>
						</div>
					</div>
				</div>
			</div>
